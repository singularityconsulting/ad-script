...
apstag.init({
  pubID:
    document.currentScript.getAttribute('apstagId') ||
    '3b1c3bb9-0a92-42c7-89f2-ab90b652b552', // **b552 pubID is for CookingProfessionally, please replace with new ID for funnyEditor before release
  adServer: 'googletag',
  bidTimeout: 500,
})
  ...
  googletag.cmd.push(() => {
    ...
    if (Array.isArray(slots)) {
      ...
      if (slot?.type === 'sidebar') {
        sizes = [...stickySizes, ...stickySizesSmall]
      } else {
